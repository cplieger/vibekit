...
// configPlane owns the KAS CONFIGURATION surface: knowledge bases, hooks, the
...
// runtime kept for exactly this class of call — while the rest of the hub talks to
...
//
// utility arrives as a thunk for the same reason runPlane's does: the runtime is
...
func newConfigPlane(lc *lifecyclePlane, broadcast func(context.Context, vibekit.ServerEvent)) *configPlane {
	return &configPlane{
