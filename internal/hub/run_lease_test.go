...
// Tests for the hub side of a run lease: what a launch records, what a terminal
...
// on: a Hub built without the durable store still has a lease registry, because a
