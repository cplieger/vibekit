...
//
// We only handle the classic 3-marker form. `|||||||` base sections from
// git's diff3 style are tolerated (kept as part of the "ours" chunk) but
// not surfaced separately — the inline resolution UI is 2-way.
// ---------------------------------------------------------------------------
