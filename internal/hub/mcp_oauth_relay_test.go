...
func postRelay(t *testing.T, h *Hub, server, pasted string) *httptest.ResponseRecorder {
	t.Helper()
...
func stageFlow(t *testing.T, h *Hub, server, listenerURL, state string) {
	t.Helper()
...
func relayState(t *testing.T, h *Hub, server string) (relayed, pending bool) {
	t.Helper()
