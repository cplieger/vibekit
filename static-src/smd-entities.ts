...
//
// The HTML5 named character references, from the WHATWG list at
// https://html.spec.whatwg.org/entities.json. CommonMark 6.2 defines a valid
// named reference as membership in that table, so the table IS the rule and a
// curated subset would be a second, private one.
//
...
//   node _scratch/md-round3-r3/gen-entities.mjs /tmp/entities-whatwg.json \
