...
func hubWithRealStore(t *testing.T) (*Hub, string) {
	t.Helper()
	dir := t.TempDir()
	...
	h := New(t.Context(), t.TempDir(), func() api.ACPBridge { return br }, cs)
...
func runTerminalTurn(t *testing.T, h *Hub, frames ...string) {
	t.Helper()
