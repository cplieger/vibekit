...
func (cp *Settings) hookScopeAndPath(abs string) (scope, path string) {
	if abs == "" {
...
func (cp *Settings) hooksListRaw(ctx context.Context) ([]kasHook, error) {
	u := cp.utility()
...
func (cp *Settings) toHookInfo(k *kasHook) hookInfo {
...
func (cp *Settings) handleHooksList(w http.ResponseWriter, r *http.Request) {
...
func (cp *Settings) handleHookSetEnabled(w http.ResponseWriter, r *http.Request) {
...
func (cp *Settings) broadcastHooksChanged() {
...
func (cp *Settings) writeHookResultErr(w http.ResponseWriter, res kasHookResult) {
...
func (cp *Settings) writeHookErr(w http.ResponseWriter, err error) {
...
func (cp *Settings) registerHooksRoutes(mux *http.ServeMux) {
