...
func (cp *Settings) knowledgeCall(ctx context.Context, params map[string]any) (json.RawMessage, error) {
	u := cp.utility()
...
// operations.
func (cp *Settings) knowledgeShow(ctx context.Context) ([]knowledgeContext, error) {
...
func (cp *Settings) resolveKnowledgePath(p string) string {
	if filepath.IsAbs(p) {
...
// still indexing.
func (cp *Settings) handleKnowledgeList(w http.ResponseWriter, r *http.Request) {
...
func (cp *Settings) handleKnowledgeAdd(w http.ResponseWriter, r *http.Request) {
...
func (cp *Settings) handleKnowledgeRemove(w http.ResponseWriter, r *http.Request) {
...
func (cp *Settings) knowledgeMutate(ctx context.Context, params map[string]any) (*kasKnowledgeResult, error) {
...
func (cp *Settings) writeKnowledgeErr(w http.ResponseWriter, err error) {
...
func (cp *Settings) registerKnowledgeRoutes(mux *http.ServeMux) {
