...
// (see github.com/cplieger/web-terminal-engine/v2/terminal). The server maintains a VT500
// screen buffer (github.com/cplieger/web-terminal-engine/v2/vt) and sends only changed rows
