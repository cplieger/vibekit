...
func CmdCreateHook(d *Dispatcher, workspace WorkspaceAccess, ctx context.Context, w http.ResponseWriter, cmd *vibekit.ClientCommand) { //nolint:revive // context-as-argument: dispatcher handler signature
	...
	hookPath := filepath.Join(workspace.WorkDir(), ".kiro", "hooks", safeName+".json")
