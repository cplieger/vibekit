...
// (see github.com/cplieger/web-terminal/terminal). The server maintains a VT500
// screen buffer (github.com/cplieger/web-terminal/vt) and sends only changed rows
